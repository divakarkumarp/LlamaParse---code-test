...
llama_parse_documents = LlamaParse(api_key=llamaparse_api_key, result_type="markdown").load_data("./data/Uber-Q4-22-Earnings-Press-Release.pdf")
...
def load_or_parse_data():
    ...
    if os.path.exists(data_file):
        ...
        #llama_parse_documents = LlamaParse(api_key=llamaparse_api_key, result_type="markdown").load_data(".data/Uber-Q4-22-Earnings-Press-Release.pdf")
        llama_parse_documents = LlamaParse(api_key=llamaparse_api_key, result_type="markdown").load_data("./data/32073.ppt")
...
# query the engine
query = "what are Recurent neural networks?"
#query = "what is Financial Highlights for Fourth Quarter 2022 ? "
